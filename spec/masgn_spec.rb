describe "A Masgn node" do
  ...
  parse "a, = []" do
    [:masgn, [:array, [:lasgn, :a]], [:to_ary, [:array]]]
  end
  ...
  parse "*a = nil" do
    [:masgn, [:array, [:splat, [:lasgn, :a]]], [:array, [:nil]]]
  end
  ...
  parse "(*) = x" do
    [:masgn, [:array, [:splat]], [:array, [:call, nil, :x, [:arglist]]]]
  end
  ...
  parse "(*a, b) = m x" do
    [:masgn,
     [:array, [:splat, [:lasgn, :a]]],
     [:lasgn, :b],
     [:array, [:call, nil, :m, [:arglist, [:call, nil, :x, [:arglist]]]]]]
  end
